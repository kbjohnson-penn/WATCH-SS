...
def transcribe(audio_path, whisper_model, language, temperature, device, output_format, output_dir, batch_size=16, compute_type="float16"):
    """
...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(args.output_dir, os.path.basename(args.audio).rsplit(".", 1)[0] + ".json")):
        ...
        transcribe(args.audio, args.whisper_model, args.language, args.temperature, args.device, args.output_format, args.output_dir)
